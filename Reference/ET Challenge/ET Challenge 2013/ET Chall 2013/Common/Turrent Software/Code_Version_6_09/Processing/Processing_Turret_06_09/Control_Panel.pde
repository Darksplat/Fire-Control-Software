...
void drawControlPanel() {
  ...
  label_xMax = new GLabel(this, "xMax: 180", 185, 362, 150, 20);
  ...
  label_yMin = new GLabel(this, "yMin: 000", 35, 402, 150, 20);
  ...
  label_yMax = new GLabel(this, "yMax: 180", 185, 402, 150, 20);
  ...
  label_setxMin = new GLabel(this, "to set xMin press A", 10, 385, 120, 10);
  panel_main.add(label_setxMin);

  label_setxMax = new GLabel(this, "to set xMax press D", 160, 385, 120, 10);
  panel_main.add(label_setxMax);

  label_setyMin = new GLabel(this, "to set yMin press S", 10, 415, 120, 10);
  panel_main.add(label_setyMin);

  label_setyMax = new GLabel(this, "to set yMax press W", 160, 415, 120, 10);
  ...
  checkbox_controlMode = new GCheckbox(this, "Enable Autonomous Mode", 10, 25, 10);
  ...
  button_saveSettings = new GButton(this, "Save Settings to Controller Memory", 320, 100, 260, 10);
  panel_main.add(button_saveSettings);

  button_restoreSettings = new GButton(this, "Load Settings from Controller Memory", 320, 120, 260, 10);
  panel_main.add(button_restoreSettings);

  if (runWithoutArduino) {
    button_saveSettings.setEnabled(false);
    button_saveSettings.setColorScheme(GCScheme.GREY_SCHEME);
    button_restoreSettings.setEnabled(false);
    button_restoreSettings.setColorScheme(GCScheme.GREY_SCHEME);
  }
  ...
  window_main = new GWindow(this, "Control Panel", controlPanelWindowX, controlPanelWindowY, 600, 600, true, null);
  window_main.setBackground(panelBackgroundImg);
...
public void handleButtonEvents(GButton button) {
  ...
  if (button == button_restoreSettings && button.eventType == GButton.CLICKED) {
    restoreSettings();
  }
  if (button == button_retryArduinoConnect && button.eventType == GButton.CLICKED) {
    ...
    button_saveSettings.setEnabled(true);
    button_saveSettings.setColorScheme(GCScheme.GREY_SCHEME);
    button_restoreSettings.setEnabled(true);
    button_restoreSettings.setColorScheme(GCScheme.GREY_SCHEME);
    runWithoutArduino = false;
    retryArduinoConnect();    
    if (runWithoutArduino) {
